...
// Terracotta primary CTA, Cormorant headline, ambient glow in D3 palette.
    ...
    <section ref={ref} style={{ background: `linear-gradient(160deg, #1e1710 0%, ${D3.walnut} 50%, #1e1710 100%)`, padding: '8rem 1.5rem', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, maxWidth: '52rem', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div className="vcta-item" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '2.5rem' }}>
          ...
          <span style={{ fontFamily: 'var(--font-josefin), system-ui, sans-serif', fontSize: '0.65rem', letterSpacing: '0.35em', textTransform: 'uppercase', color: D3.terracotta }}>Limited Spots Available</span>
          <span style={{ display: 'block', height: '1px', width: '40px', background: D3.terracotta }} />
        </div>
        ...
        <p className="vcta-item" style={{ fontFamily: 'var(--font-inter), system-ui, sans-serif', fontSize: '1rem', color: D3.wheat, opacity: 0.55, lineHeight: 1.8, maxWidth: '36rem', margin: '0 auto 3rem' }}>
          Join a community of passionate food entrepreneurs in the heart of Las Cruces. Apply today and secure your place in the founding cohort.
        </p>

        <div className="vcta-item" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
          <Link href="/vendors" style={{ background: D3.terracotta, color: D3.parchment, padding: '1rem 2.5rem', fontFamily: 'var(--font-josefin), system-ui, sans-serif', fontSize: '0.7rem', letterSpacing: '0.25em', textTransform: 'uppercase', textDecoration: 'none', fontWeight: 600, transition: 'opacity 0.25s' }}
            onMouseEnter={e => (e.currentTarget.style.opacity = '0.88')}
            onMouseLeave={e => (e.currentTarget.style.opacity = '1')}
          >Apply as a Vendor →</Link>
          <Link href="/investors" style={{ border: '1px solid rgba(247,243,236,0.2)', color: `${D3.wheat}bb`, padding: '0.95rem 2.5rem', fontFamily: 'var(--font-josefin), system-ui, sans-serif', fontSize: '0.7rem', letterSpacing: '0.25em', textTransform: 'uppercase', textDecoration: 'none', transition: 'border-color 0.3s, color 0.3s' }}
        ...
        <p className="vcta-item" style={{ marginTop: '2.5rem', fontFamily: 'var(--font-josefin), system-ui, sans-serif', fontSize: '0.58rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: `${D3.wheat}35` }}>Opening Q1–Q2 2027 · Downtown Las Cruces, NM</p>
      </div>
    </section>
  );
}
