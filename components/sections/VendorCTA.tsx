...
// Luxury upgrades:
//   • Primary button: background darkens on hover + radial ripple on pointerdown.
//   • Ghost buttons: lift translateY(-1px) on hover.
//   • Ripple is pure JS — creates/removes a span on pointerdown.
        ...
        <div className="vcta-item" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
          ...
          <Link
            ...
            style={{
              ...
              border: '1px solid rgba(192,98,42,0.45)', color: `${D3.wheat}cc`,
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLAnchorElement).style.borderColor = `rgba(192,98,42,0.85)`;
              (e.currentTarget as HTMLAnchorElement).style.color       = D3.parchment;
              (e.currentTarget as HTMLAnchorElement).style.transform   = 'translateY(-1px)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(192,98,42,0.45)';
              (e.currentTarget as HTMLAnchorElement).style.color       = `${D3.wheat}cc`;
              (e.currentTarget as HTMLAnchorElement).style.transform   = 'translateY(0)';
            }}
          >
          ...
          <Link
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLAnchorElement).style.borderColor = `rgba(192,98,42,0.55)`;
              (e.currentTarget as HTMLAnchorElement).style.color       = D3.parchment;
              (e.currentTarget as HTMLAnchorElement).style.transform   = 'translateY(-1px)';
            }}
            onMouseLeave={e => {
