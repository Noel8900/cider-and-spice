    ...
    >
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="text-center">
          <p
            className="font-sans text-xs font-semibold uppercase tracking-widest text-cream/35 mb-3"
          >
            Get in Touch
          </p>
          <a
          ...
          <p
            className="mt-2 font-sans text-sm text-cream/45"
          >
        ...
        {/* ── Disclaimer ─────────────────────────────────────────────── */}
        <p
          className="text-center font-sans text-[10px] leading-relaxed text-cream/20"
        >
