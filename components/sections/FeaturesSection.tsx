      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Link href="/floor-plan/" className="group block mt-6">
          <GlassCard className="p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-6
                                border-ember/30 hover:border-ember/70
            ...
            <div className="shrink-0 flex items-center gap-2 rounded-full bg-ember/15
                            border border-ember/40 px-6 py-3 font-sans text-sm
                            font-semibold text-ember group-hover:bg-ember/25
                            group-hover:border-ember/70 transition-all duration-200
