  ...
  return (
    <main style={{ background: D3.chestnut, minHeight: '100svh' }}>
      ...
      <div style={{ background: D3.walnut, padding: '7rem 1.5rem 5rem', position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Ambient glow */}
        <div style={{ pointerEvents: 'none', position: 'absolute', top: '-5rem', right: '-5rem', width: '400px', height: '400px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(192,98,42,0.08) 0%, transparent 65%)', filter: 'blur(55px)' }} aria-hidden="true" />

        <div style={{ maxWidth: '52rem', margin: '0 auto' }}>

          {/* Back breadcrumb — points to /vendors/onboarding */}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <span style={{ fontFamily: 'var(--font-josefin), system-ui, sans-serif', fontSize: '0.62rem', letterSpacing: '0.32em', textTransform: 'uppercase', color: D3.terracotta }}>NMED 7.6.2 NMAC &middot; 2017 FDA Food Code</span>
          </div>
          ...
          <p style={{ fontFamily: 'var(--font-inter), system-ui, sans-serif', fontSize: '1rem', lineHeight: 1.8, color: `${D3.wheat}80`, maxWidth: '480px', marginBottom: '2.5rem' }}>
            Seven operational zones, four house rules, and a six-item compliance checklist &mdash;
            every vendor must complete and maintain this binder before building access
            or kitchen time is granted.
          </p>
      ...
      {/* Walnut-to-chestnut transition divider */}
