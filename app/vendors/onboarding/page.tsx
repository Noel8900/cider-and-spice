  ...
  return (
    <main style={{ background: D3.walnut, minHeight: '100svh' }}>
      ...
      <div style={{ padding: '7rem 1.5rem 5rem', position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Ambient glow */}
        <div style={{ pointerEvents: 'none', position: 'absolute', top: '-5rem', left: '-5rem', width: '450px', height: '450px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(107,140,107,0.07) 0%, transparent 65%)', filter: 'blur(55px)' }} aria-hidden="true" />

        <div style={{ maxWidth: '52rem', margin: '0 auto' }}>

          {/* Back breadcrumb — points to /vendors since this is a sub-page */}
          <Link href="/vendors"
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <span style={{ fontFamily: 'var(--font-josefin), system-ui, sans-serif', fontSize: '0.62rem', letterSpacing: '0.32em', textTransform: 'uppercase', color: D3.terracotta }}>Founding Cohort &mdash; 8-Step Journey</span>
          </div>
          ...
          <p style={{ fontFamily: 'var(--font-inter), system-ui, sans-serif', fontSize: '1rem', lineHeight: 1.8, color: `${D3.wheat}80`, maxWidth: '480px', marginBottom: '2.5rem' }}>
            Eight structured milestones &mdash; from first outreach through a supported soft launch
            and on to a clear graduation pathway &mdash; with coaching from our Incubator Director
            and selection committee at every stage.
          </p>
