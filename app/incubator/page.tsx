...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://www.lccullinaryhub.com/incubator',
      url: 'https://www.lccullinaryhub.com/incubator',
      name: 'Culinary Incubator Program — Las Cruces Culinary Innovation Hub',
      description:
        'Semilla and Mariposa culinary incubator pathways, a five-phase launch strategy, and a performance dashboard built for food entrepreneurs in Las Cruces, New Mexico.',
      inLanguage: 'en-US',
      isPartOf: {
        '@type': 'WebSite',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: 'https://www.lccullinaryhub.com/incubator',
        },
      ],
    },
  ],
      ...
      <div style={{ padding: '7rem 1.5rem 5rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div
          ...
          style={{
            ...
            background: 'radial-gradient(circle, rgba(192,98,42,0.09) 0%, transparent 65%)',
            filter: 'blur(60px)',
          }}
        />
        ...
        <div style={{ maxWidth: '52rem', margin: '0 auto' }}>
          ...
          <p style={{
            ...
            Southern New Mexico&rsquo;s first structured culinary incubator &mdash; two defined
            pathways, five launch phases, and a performance dashboard built to turn food ideas
