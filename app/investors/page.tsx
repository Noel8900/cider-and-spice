...
import FormField, { darkInput } from '@/components/ui/FormField';
    ...
    <main className="min-h-screen bg-bg">
      ...
      <div className="px-6 pb-20 pt-28">
        <div className="mx-auto max-w-4xl">
          <Button variant="ghost" href="/" className="mb-10 gap-1.5">
            <BackArrow />
            Back to the Hub
          </Button>
          ...
          <div className="text-center">
            ...
            <p className="mx-auto max-w-2xl font-sans text-lg leading-relaxed text-cream/65">
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-2 gap-6 md:grid-cols-4">
          {METRICS.map(({ value, label }) => (
            <div key={label} className="text-center">
              ...
              <div className="font-sans text-xs leading-snug text-cream/50">
                {label}
              </div>
            </div>
          ))}
      ...
      <div className="px-6 py-20">
        <div className="mx-auto max-w-5xl space-y-20">
          ...
          <div>
            ...
            <p className="mb-12 text-center font-sans text-base text-cream/55">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  >
                    <textarea
                      ...
                      disabled={submitting}
                      aria-invalid={!!error}
                      aria-describedby="inv-message-hint"
