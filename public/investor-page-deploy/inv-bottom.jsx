...
const FAQS_DATA = [
  { q: 'What is the minimum investment?', a: 'Minimum investment details are discussed privately. All discussions are conducted privately — there are no online transactions. Submit a request and we\'ll follow up within 48 hours.' },
...
const RANGES = [
  { value: '',                  label: 'Select participation interest…', disabled: true },
  { value: 'community',         label: 'Community Investor'                         },
  { value: 'growth',            label: 'Growth Partner'                             },
  { value: 'founding',          label: 'Founding Investor'                          },
