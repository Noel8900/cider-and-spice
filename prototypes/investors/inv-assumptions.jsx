...
var DRIVERS = [
  { stream: 'Kitchen stalls & ghost kitchens', formula: 'stalls × base rent + % rent', note: 'Driven by stalls under license, average monthly base rent, and percentage-rent participation tied to tenant sales. Year 1 is a partial-year contribution; Year 2 is all 13 stalls for the full year.' },
...
var REVIEWER_QA = [
  {
    ...
    a: [
      'Full-year operation of all 13 stalls and shared kitchen assets, versus a staggered Year 1 opening where seven stalls launch and others are added over the first 9–11 months.',
      'Higher utilization of kitchen rentals and ghost-kitchen capacity, increased cider bar and retail traffic as the Hub establishes itself as a destination, and a fuller calendar of events and training built on Year-1 pilot offerings.',
    ],
  },
  {
  ...
  },
  {
    ...
    a: [
      'The model separates one-time capital and ramp funding from ongoing operations. The $655K of grants and owner capital, with the $850K SBA 7(a) loan, funds leasehold improvements, equipment, soft costs, and a $272K opening working-capital reserve — not permanent operating subsidy.',
      'Operating loss narrows from ~$433.9K in Year 1 to ~$88.1K in Year 2, with positive cash balances throughout. At stabilization, the model shifts to a diversified earned-revenue mix — stall and percentage rent, memberships, kitchen rentals, cider and retail, and a developed events calendar.',
    ],
  },
];
    ...
    <section id="assumptions" style={{ paddingTop: '2rem', paddingBottom: '5rem' }}>
      ...
      <FadeUp style={{ marginBottom: '3.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '1px', background: INV.bord }}>
          <SplitPanel tone="high" tag="Material COGS" title="Cider bar & retail product" body="Direct cost of goods is concentrated here, modeled at typical beverage and retail margins. Cost of Sales rises in absolute terms — ~$53K in Year 1 to ~$88.8K in Year 2 — tracking sales at a steady ratio." />
      ...
      <FadeUp style={{ marginBottom: '3.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '1px', background: INV.bord }}>
          <SplitPanel tone="high" tag="Fixed core · exists regardless of tenants" title="GM · operations · marketing · admin" body="The base team that runs the facility whether 7 or 13 stalls are occupied. Personnel cost grows from ~$600K (Year 1) to ~$685K (Year 2) including benefits and payroll taxes — deliberately slower than revenue." />
      ...
      <FadeUp style={{ marginBottom: '3.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1px', flexWrap: 'wrap', background: INV.bord, marginBottom: '1.1rem' }}>
          <TrajStep phase="Year 1 · Ramp" label="Staggered open, 7 stalls building to near-full" revenue="$757K" loss="Operating loss ≈ −$433.9K" result="Funded by the $272K opening reserve and financing — positive cash balance maintained throughout." />
          <TrajStep phase="Year 2 · Near-stabilized" label="All 13 stalls live for the full year" revenue="$1.27M" loss="Operating loss ≈ −$88.1K" result="Loss narrows ~80%. Modest gains in utilization, pricing, or program mix close the remaining gap — without additional grant support." last />
        </div>
        <p style={{ fontFamily: INV_F.b, fontSize: '0.8rem', lineHeight: 1.7, color: INV.wheat, opacity: 0.45, maxWidth: '46rem', margin: 0 }}>
          Grants and owner capital ($655K) and the SBA 7(a) loan ($850K) fund buildout, equipment, soft costs, and the working-capital reserve — capital and targeted innovation, never recurring operating subsidy.
        </p>
      </FadeUp>
