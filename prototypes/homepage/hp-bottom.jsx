...
const FAQS = [
  ...
  { q:'Where exactly will the Hub be located?', a:"The Hub will be located on East Lohman Ave in downtown Las Cruces — within a zoning area designated Urban Character under the Realize Las Cruces 2025 Zoning Code, directly within an active MRA redevelopment zone. The exact address will be announced when the lease is finalized." },
